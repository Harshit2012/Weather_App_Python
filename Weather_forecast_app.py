...
header_label = tk.Label(root, text='Weather Forecast App', font=('Arial', 20))
header_label.pack(pady=10)

city_frame = tk.Frame(root)
city_frame.pack()

city_entry = tk.Entry(city_frame, font=('Arial', 14))
city_entry.pack(side=tk.LEFT, padx=5)

search_button = tk.Button(city_frame, text='Search', command=get_weather, font=('Arial', 14))
